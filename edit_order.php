    ...
    try {
        ...
        $stmtDetail = $conn->prepare("INSERT INTO order_item_detail 
            (order_id, order_no, item_id, color, cup, size_32, size_34, size_36, size_38, size_40, size_42, 
             size_44, size_46, size_48, size_50, total_qty, cid, created_at, updated_at) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())");
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-add-row" onclick="addRow(<?= $idx ?>)">
                                            <i class="bi bi-plus-lg"></i> Add Row
                                        </button>
                                    </div>
                                    <div id="rows-<?= $idx ?>" class="mt-3">
